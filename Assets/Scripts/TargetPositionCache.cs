...
{
    /// <summary>Unmodified copy of the TargetPositionCache class from the Cinemachine package.</summary>
    internal class TargetPositionCache
    {
#if UNITY_EDITOR
        public static bool UseCache => false;
        //public static bool UseCache => Unity.Cinemachine.Editor.CinemachineTimelinePrefs.UseScrubbingCache.Value;
#else
        public static bool UseCache => false;
#endif
